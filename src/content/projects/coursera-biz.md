...
subtitle: Enterprise Website Redesign
...
metrics:
  - '+20% Marketing Qualified Lead (MQL) lift'
...
<div class="cs-split">
  <div class="cs-split-body">
    <p>The team adopted a modular "chunks" approach based on content strategist Karen McGrane's principles. Each page section was structured around a "Why, How, Proof" arc — connecting with buyer goals, describing Coursera's unique approach, then closing with social proof and metrics.</p>
...
<div class="cs-split">
  <div class="cs-split-body">
    <p>The phased rollout launched on Coursera for Business first while Government and Higher Ed remained on legacy platforms. Navigation needed to serve two audiences simultaneously — buyers actively evaluating, and returning customers seeking resources.</p>
...
<div class="cs-split">
  <div class="cs-split-body">
    <p>The site launched July 1st on schedule. An A/B test showed the new design initially appeared to underperform, but ultimately surpassed the old site by week's end — comfortably hitting the 20% MQL target.</p>
    <p>The success established a foundation for extending the design system across Government and Higher Ed properties, and influenced the broader consumer site strategy toward unified design standards.</p>
  </div>
  <div class="cs-split-image">
